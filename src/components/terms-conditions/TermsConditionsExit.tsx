    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 w-full max-w-[1200px] mx-auto flex flex-col items-center justify-center text-center text-white px-6">
                ...
                <a href={` ${cleanUrl ?? null} `} target={` ${termsConditionsExit.ctaLink?.target ?? null} `} className="inline-flex items-center justify-center rounded-md px-8 py-3 font-semibold text-white gradient-border mt-4">
