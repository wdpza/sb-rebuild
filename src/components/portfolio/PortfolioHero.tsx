...
export default function PortfolioHero(portfolioOptions : any) {
    ...
    return (
        ...
        >
            <div className="h-screen relative z-10 grid w-full max-w-[1400px] mx-auto grid-cols-1 md:grid-cols-24 gap-2 px-12 py-24 mt-12">
                <div className="col-span-13 flex w-full max-w-[600px] flex-col justify-center text-left gap-4">
