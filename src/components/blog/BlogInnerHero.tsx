...
export default function BlogInnerHero({ background, title } : any) {
    ...
    return (
        <section
            className="relative flex h-[800px] w-full items-center bg-cover bg-bottom bg-no-repeat overflow-hidden"
            style={{
                backgroundImage: background ? `url(${background})` : undefined,
            }}
        >
            <div className="absolute inset-0 bg-black/60 z-0"></div>
            <div className="h-[800px] relative z-10 grid w-full max-w-[1600px] mx-auto grid-cols-1 md:grid-cols-24 gap-2 px-12 py-24">
