    ...
    >
      ...
      <div className="relative">
        <select
          ...
          onChange={handleChange}
          className="appearance-none bg-[#1F1F1F96] placeholder-white text-neutral-softest border border-[#353536] p-3 rounded w-full pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
